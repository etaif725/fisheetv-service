...
#define MyAppName "FisheeTV Service"
#define MyAppShortName "FisheeTVService"
#define MyAppExeName "stremio-service.exe"
#define MyAppRoot SourcePath + "..\"
#define MyAppBinLocation SourcePath + "target\release\"
...
#define MyAppPublisher "Smart Code OOD & FisheeTV"
#define MyAppCopyright "Copyright (C) 2017-" + GetDateTimeString('yyyy', '', '') + " " + MyAppPublisher
#define MyAppURL "https://fishee.tv/"
#define MyAppGoodbyeURL "https://fishee.tv/goodbye"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{2A9696BD-4EC6-4583-B61E-2E790387AAF8}
AppName={#MyAppName}
